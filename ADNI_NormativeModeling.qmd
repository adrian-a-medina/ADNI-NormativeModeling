...
# Read in finalized file, to be used ONLY for group cortical thickness comparisons
...
df <- dplyr::rename(df, SubjectID = "Subject_ID")

# Merge datasets on SubjectID
ADNI_PDC <- inner_join(df, PDC_BLR, by = "SubjectID")
