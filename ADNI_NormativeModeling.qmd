...
format:
  lumo-html: 
    logo:                              # Optional. Path to a logo displayed above the title
...
```{r Binarize Outliers and Create Total Outlier Score Across Total ROIs, message=FALSE, warning=FALSE}
